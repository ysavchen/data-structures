...
public class SequenceSum {
     ...
     * Например, массив {@code [2, 8, 10, 25]} на первом рекурсивном вызове разбивается на {@code [2] + [8, 10, 25]}.<br/>
     * Базовый случай сумма одного элемента - 25, потом возвращаемся считаем сумму 10 + 25 etc.
     */

 ...
 * Опорный элемент (pivot) разделяет массив на два под-массива: меньше опорного элемента и больше.
 * </li>
 * <li>
 ...
 * Алгоритм рекурсивно применяются к под-массивам слева и справа от опорного элемента.<br/>
 * Процесс продолжается, пока под-массивы не станут пустыми или состоящими из одного элемента.
